<?php
    ...
    function getTransactionByUserId() {
        ...
        $sql = "select p.product_name, p.product_price, t.ammount, t.transaction_date, t.ammount * p.product_price as `total_price` from transaction t join user u on t.user_id = u.user_id join product p on p.product_id = t.product_id where u.user_id = $user_id order by t.transaction_date desc";
